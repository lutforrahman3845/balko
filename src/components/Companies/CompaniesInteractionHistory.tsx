...
const CompaniesInteractionHistory = ({
  ...
  selectedId,
  data = null,
}: CompaniesInteractionHistoryProps) => {
  const [limit, setLimit] = useState(20);
  const [historyData, setHistoryData] =
    useState<CompanyInteractionHistoryResponse | null>(null);
  const {
    data: history,
    isLoading,
    error,
  ...
  const currentCount = historyData
    ? historyData.companyConatact.length + historyData.conatactsHistory.length
    : 0;
            ...
            <div className="px-4 py-6">
              ...
              {isLoading ? (
                          ...
                          >
                            ...
                            <div className="flex items-center justify-between relative">
                              <div className="flex items-center gap-3">
                                <div className="size-6 rounded-full bg-muted/30 border border-border/60 flex items-center justify-center z-10">
                            ...
                            <div className="text-[13px] text-muted-foreground leading-normal font-medium ml-9">
                              {item.note ||
                                "No notes available for this interaction."}
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  {historyData.conatactsHistory.length > 0 && (
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="flex flex-col gap-6">
                        {Object.values(
                          historyData.conatactsHistory.reduce(
                            (acc, item) => {
                              ...
                              <div className="flex flex-col sm:flex-row sm:items-center gap-4 pb-4 mb-4 border-b border-border/40">
                                <div className="flex items-start gap-4 min-w-0">
                                  ...
                                  <div className="flex flex-col min-w-0">
                                    ...
                                    {group.contact.email && (
                                      <a href={`mailto:${group.contact.email}`}>
                                    ...
                                    {group.contact.phone && (
                                      <a href={`tel:${group.contact.phone}`}>
                                        <span className="text-sm text-muted-foreground font-medium ">
                                          {group.contact.phone}
                                        </span>
                                      </a>
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-muted/20 rounded-2xl border border-dashed border-border">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 max-w-50 text-center">
                    There are no recorded interactions for this company yet.
                  </p>
                </div>
              )}
            </div>

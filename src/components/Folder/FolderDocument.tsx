...
export const FolderDocumentCard = ({ document }: { document: FolderDocument }) => {
    return (
        <div className="group flex flex-col p-4 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer hover:border-gray-300 dark:hover:border-gray-700">
                ...
                <div className="mt-auto pt-4 flex items-center justify-between border-t border-gray-100 dark:border-gray-800">
                    ...
                    <div className="flex flex-col items-end">
                        <div className="flex items-center gap-1.5 mb-1.5 text-gray-400">
                            ...
                            ) : document.shareWithEmployee && document.shareWithEmployee.length > 0 ? (
        ...
        <section className="mt-8">
            ...
            {viewMode === "grid" ? (
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    {documents.map((doc) => (
                        <FolderDocumentCard key={doc.id} document={doc} />
                    ))}
                </div>
            ) : (

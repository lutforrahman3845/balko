...
const ContactedHistory = ({
  ...
  const {
    ...
    { id: selectedId || "", pageIndex: 1, pageSize: limit },
    {
      skip: !selectedId,
    },
  );
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2.5 sm:gap-6">
                      {data?.email && (
                        <a
                          ...
                          className="text-sm text-muted-foreground hover:text-foreground flex items-center gap-2.5 transition-all group w-fit"
                        >
              ...
              {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-muted/20 rounded-2xl border border-dashed border-border">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 max-w-50 text-center">
                    There are no recorded interactions for this contact yet.
                  </p>
                </div>
              )}
            </div>
